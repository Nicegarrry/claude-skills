...
No third-party dependencies. The script is intentionally small so coding agents
can run it in ordinary Python environments.
"""
...
USER_AGENT = "daily-interest-brief/1.0 (+https://openai.com)"
